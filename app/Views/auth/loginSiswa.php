            ...
            <div class="col-lg-4 mx-auto">
                ...
                <div class="auto-form-wrapper">
                    <div class="text-center mb-5">
                        ...
                        <img src="/assets/img/logo/siswa.png" alt="" class="img-fluid w-25" />
                    ...
                    <form action="<?= base_url('auth/siswa'); ?>" method="POST">
                        ...
                        <div class="form-group">
                            <label class="label">No. Ujian</label>
                            <div class="input-group">
                                <input type="text" class="form-control <?= $validation->hasError('nus') ? 'border-danger' : ''; ?>" placeholder="No. Ujian" name="nus" value="<?= old('nus'); ?>">
                                <div class="input-group-append">
                                    <span class="input-group-text <?= $validation->hasError('nus') ? 'border-danger' : ''; ?>">
                                        <?php if ($validation->hasError('nus')) : ?>
